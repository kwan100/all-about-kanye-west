...
if (!isset($_POST['voter']) || empty($_POST['voter'])) {
    ...
    $sql = "INSERT INTO voters (name, ye_id, kids_see_ghosts_id, the_college_dropout_id, yeezus_id, graduation_id, late_registration_id, 
    jesus_is_king_id, my_beautiful_dark_twisted_fantasy_id, kanye_west_presents_good_music_cruel_summer_id, 808s_id, watch_the_throne_id,
    the_life_of_pablo_id)
    VALUES('" 
    . $voter . "', "
    . $ye . ", "
    . $kids_see_ghosts . ", "
    ...
    . $kanye_west_presents_good_music_cruel_summer . ", "
    . $heartbreak . ", "
    . $watch_the_throne . ", "
    . $the_life_of_pablo . ");";
...
<body>
    ...
    <div class="body">
        <div class="info">
            SHARE YOUR FAVORITE KANYE-SONGS
        </div>
        ...
        <div class="about-info">
            <a href="share.php" role="button" class="btn btn-primary">BACK TO FORM</a>
        </div>
    </div>
