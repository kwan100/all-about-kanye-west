        ...
        <form action="edit_confirmation.php" method="POST">
            <div class="container sub-info">
                <div class="row row-edit">
				    <label for="voter-id" class="col-form-label text-sm-right">
                        NAME:<span class="text-danger">*</span>
                    </label>
                    <input type="text" class="form-control" id="voter-id" name="voter" value="<?php echo $row_info["name"];?>">
                </div>
